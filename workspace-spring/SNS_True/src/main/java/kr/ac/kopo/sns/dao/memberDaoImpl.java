...
public class memberDaoImpl implements MemberDao {
	...
	@Override
	public Member AdminUpdate(String member) {
		return sql.selectOne("member.AdminUpdate", member);
	}

	@Override
	public void UserChange(Member member) {
			sql.update("member.UserChange", member);
	}
