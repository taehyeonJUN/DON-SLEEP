...
<!--                <li><a href="#" class="icon"><img src="../../resources/images/iconmonstr-smiley-12-240.png" alt=""></a></li> -->
                    <li><img src="../../resources/images/iconmonstr-smiley-2-240.png" alt=""></a></li>
               ...
               <c:forEach var="pho" items="${item.attachList}">
                ...
                <div class="btn-area">
                    <ul>
                        ...
                        <li><img src="../../resources/images/iconmonstr-speech-bubble-12-240.png" alt="댓글"></li>
                         <li><a href='javascript: follow_func("${sessionScope.user.memId}","${item.postId}");'><img src="../../resources/images/iconmonstr-smiley-12-240.png" alt="팔로우"></a></li>
                        <li><img src="../../resources/images/iconmonstr-tree-2-240.png" alt=""></li>
                    </ul>
                </div>
                <br />
					<div class="reple-text-box">
						<span><h5>${item.postId}님이 게시함</h5></span>
						...
						<h5 class="like_count1" data-poNo="${item.postNo}">
							<b class="like_count2" data-poNo="${item.postNo}">${item.postLike}명이 좋아합니다</b>
						</h5>
					</div>
					<!--              +++여기부터 댓글+++ -->
...
<%--                    <input type="hidden" value="${sessionScope.user.memId}" class="memId" >  --%>
                ...
                <button id="submit" onclick="RpAddRe_func('댓글 저장 성공!');"><a href="javascript:RpAdd_func(${item.postNo});" data-postNo="${item.postNo};">UP</a></button> 
            </div>
        </div>
    </div>
