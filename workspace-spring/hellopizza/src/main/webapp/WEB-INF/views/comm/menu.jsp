        ...
        <c:if test="${loginUser!=null}"> <!--로그인한경우-->
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li><a href="${pageContext.request.contextPath}/order/add.do">Order</a></li>
            </ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="${pageContext.request.contextPath}/member/list.do">MemberList</a></li>
                   <li><a href="${pageContext.request.contextPath}/order/od.do">OrderList</a></li>
                  <li class="divider"></li>
                   <li><a href="${pageContext.request.contextPath}/member/edit.do?memId=${vo.memId}">정보수정</a></li>
                  <li><a href="${pageContext.request.contextPath}/member/del.do?memId=${memVo.memId}">회원탈퇴</a></li>
                </ul>
              </li>
            </ul>
          </div><!-- /.navbar-collapse -->
